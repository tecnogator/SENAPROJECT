...
- API REST Java + Spring Boot de OlympusGym
...
`10.0.2.2` representa el localhost del computador desde el emulador Android. En un teléfono físico debe utilizarse la IP local del computador, por ejemplo `http://192.168.1.20:8080/api`.
