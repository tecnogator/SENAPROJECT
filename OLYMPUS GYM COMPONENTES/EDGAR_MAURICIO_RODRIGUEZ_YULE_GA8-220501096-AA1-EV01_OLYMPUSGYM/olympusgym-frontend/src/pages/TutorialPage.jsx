...
export default function TutorialPage() {
  return (
    <>
      <PageHeader eyebrow="Contenido educativo" title="Guía para armar tu rutina" description="Componente educativo reutilizable integrado en la navegación de OlympusGym." />
