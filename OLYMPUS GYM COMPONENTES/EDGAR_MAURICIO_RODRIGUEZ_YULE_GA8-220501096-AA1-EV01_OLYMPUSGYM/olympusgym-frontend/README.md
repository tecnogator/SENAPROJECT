...
Frontend integrado de OlympusGym para la evidencia **GA8-220501096-AA1-EV01 — Desarrollar software a partir de la integración de sus módulos componentes**.

El cliente React consume la API REST desarrollada con Node.js + Express. Integra autenticación, dashboard, rutinas, alimentación, suplementos, membresías y guía de entrenamiento.
...
1. Inicie `olympusgym-api` en `http://localhost:3000`.
...
La configuración normal usa la API Express real. El modo demo queda disponible únicamente como apoyo visual y no se emplea en las evidencias de integración.
...
| Módulo React | Operaciones Express |
|---|---|
