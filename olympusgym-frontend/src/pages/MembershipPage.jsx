...
const plans = [
  {
    name: 'Plan Básico', type: 'Mensual', price: '$25.000', icon: Flame,
    features: ['Acceso a máquinas', 'Área de cardio', 'Seguimiento de rutina'],
  },
  {
    name: 'Plan Premium', type: 'Trimestral', price: '$45.000', icon: Sparkles, popular: true,
    features: ['Acceso total', 'Clases grupales', 'Evaluación física', 'Plan nutricional'],
  },
  {
    name: 'Plan Elite', type: 'Anual', price: '$70.000', icon: Crown,
...
export default function MembershipPage() {
  ...
  return (
    <>
      <PageHeader eyebrow="Acceso al gimnasio" title="Planes de membresía" description="Diseño migrado del módulo PHP original y conectado con la API Spring Boot." />
