    ...
    <>
      ...
      <section className="content-grid content-grid--form">
        <article className="panel supplement-feature">
          ...
          <p>
            Este módulo transforma la sección de suplementos del frontend PHP
            original en un componente React conectado con Spring Boot.
          </p>
        ...
        <article className="panel form-panel">
          ...
          <p>El backend disponible expone la operación de creación mediante POST.</p>
